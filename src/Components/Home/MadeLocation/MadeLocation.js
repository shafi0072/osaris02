    ...
    return (
        <div className='bangladesh-container'>
            ...
            <div className='row bangladesh-text-container'>
                <div className='col-md-7 bangladesh-text'>
                    <div>
                        <h1 className='bangladesh-h1'>PROUDLY MADE IN <br/>BANGLADESH</h1>
                        <p className='bangladesh-p'>Over the past 5 years, we’ve worked dedicated & passionate to build something that brings happiness to the Musicians around the country.
                        ...
                        <h4 className='bangladesh-h4'>We Are Proudly Made in Bangladesh</h4>
                    </div>
                </div>
                <div className='col-md-5'>
                    <div>
                        <img className='bangladesh-map' src={BangladeshMap}/>
                    </div>
                </div>
            </div>
        </div>
